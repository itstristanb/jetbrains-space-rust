...
pub struct ChatChannelSubscriptionFilter {
    ...
    pub contact: Option<Box<crate::models::ChatContactRecord>>,
}

impl ChatChannelSubscriptionFilter {
    pub fn new() -> ChatChannelSubscriptionFilter {
