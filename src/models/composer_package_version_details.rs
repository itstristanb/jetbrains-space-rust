...
pub struct ComposerPackageVersionDetails {
    #[serde(rename = "type")]
    ...
    pub dependencies: Vec<crate::models::ComposerPackageDependency>,
...
impl ComposerPackageVersionDetails {
    pub fn new(r#type: crate::models::PackageType, repository: String, name: String, version: String, created: i64, downloads: i64, pinned: bool, disk_size: i64, dependencies: Vec<crate::models::ComposerPackageDependency>) -> ComposerPackageVersionDetails {
