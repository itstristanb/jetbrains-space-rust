...
pub struct PackagesSubscriptionFilter {
    #[serde(rename = "project", skip_serializing_if = "Option::is_none")]
    pub project: Option<Box<crate::models::PrProject>>,
    #[serde(rename = "repository", skip_serializing_if = "Option::is_none")]
    pub repository: Option<Box<crate::models::ProjectPackageRepository>>,
...
impl PackagesSubscriptionFilter {
    pub fn new(name_pattern: Vec<String>) -> PackagesSubscriptionFilter {
