...
pub struct ChatMessageReactionRemovedEvent {
...
impl ChatMessageReactionRemovedEvent {
    pub fn new(message_id: String, channel_id: String, actor: crate::models::CPrincipal, emoji: String, new_count: i32) -> ChatMessageReactionRemovedEvent {
