...
pub struct TeamDirectoryLocationsIdPatchRequest {
    ...
    #[serde(rename = "customWorkdays", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub custom_workdays: Option<Option<bool>>,
...
impl TeamDirectoryLocationsIdPatchRequest {
    pub fn new() -> TeamDirectoryLocationsIdPatchRequest {
        TeamDirectoryLocationsIdPatchRequest {
            name: None,
            timezone: None,
            custom_workdays: None,
            workdays: None,
            phones: None,
            emails: None,
            equipment: None,
