...
pub struct GettingStartedUiExtensionIn {
...
impl GettingStartedUiExtensionIn {
    pub fn new(getting_started_url: String, getting_started_title: String) -> GettingStartedUiExtensionIn {
