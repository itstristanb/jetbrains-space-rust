...
pub struct CodeReviewParticipants {
    #[serde(rename = "id")]
    pub id: String,
...
impl CodeReviewParticipants {
    pub fn new(id: String, reviewers: Vec<crate::models::CodeReviewParticipantRecord>, authors: Vec<crate::models::CodeReviewParticipantRecord>, watchers: Vec<crate::models::CodeReviewParticipantRecord>) -> CodeReviewParticipants {
