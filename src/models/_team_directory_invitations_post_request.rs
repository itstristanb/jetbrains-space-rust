...
pub struct TeamDirectoryInvitationsPostRequest {
...
impl TeamDirectoryInvitationsPostRequest {
    pub fn new(invitee_email: String) -> TeamDirectoryInvitationsPostRequest {
