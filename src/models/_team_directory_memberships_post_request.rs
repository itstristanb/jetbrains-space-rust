...
pub struct TeamDirectoryMembershipsPostRequest {
    #[serde(rename = "member")]
    ...
    #[serde(rename = "previousMembershipId", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub previous_membership_id: Option<Option<String>>,
...
impl TeamDirectoryMembershipsPostRequest {
    pub fn new(member: crate::models::ProfileIdentifier, team_id: String, role_id: String) -> TeamDirectoryMembershipsPostRequest {
