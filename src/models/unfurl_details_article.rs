...
pub struct UnfurlDetailsArticle {
    #[serde(rename = "article")]
    pub article: Box<crate::models::ArticleRecord>,
    #[serde(rename = "content", skip_serializing_if = "Option::is_none")]
    pub content: Option<Box<crate::models::ArticleContentRecord>>,
...
impl UnfurlDetailsArticle {
    pub fn new(article: crate::models::ArticleRecord) -> UnfurlDetailsArticle {
