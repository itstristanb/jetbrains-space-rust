...
pub struct CommitSetReviewRecord {
    #[serde(rename = "id")]
    pub id: String,
...
impl CommitSetReviewRecord {
    pub fn new(id: String, project: crate::models::ProjectKey, project_id: String, number: i32, title: String, state: crate::models::CodeReviewState, created_at: i64, reviewers: Vec<crate::models::CodeReviewParticipantRecord>, authors: Vec<crate::models::CodeReviewParticipantRecord>, watchers: Vec<crate::models::CodeReviewParticipantRecord>, discussion_counter: crate::models::DiscussionCounter, commits: Vec<crate::models::ReviewCommit>, issue_ids: Vec<String>, unfurls: Vec<crate::models::Attachment>) -> CommitSetReviewRecord {
