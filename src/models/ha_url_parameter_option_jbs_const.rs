...
pub struct HaUrlParameterOptionJbsConst {
    #[serde(rename = "value")]
    pub value: String,
...
impl HaUrlParameterOptionJbsConst {
    pub fn new(value: String, option_name: String) -> HaUrlParameterOptionJbsConst {
        HaUrlParameterOptionJbsConst {
            value,
            option_name,
            description: None,
            deprecation: None,
