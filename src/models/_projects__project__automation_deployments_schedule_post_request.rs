...
pub struct ProjectsProjectAutomationDeploymentsSchedulePostRequest {
...
impl ProjectsProjectAutomationDeploymentsSchedulePostRequest {
    pub fn new(target_identifier: crate::models::TargetIdentifier) -> ProjectsProjectAutomationDeploymentsSchedulePostRequest {
        ProjectsProjectAutomationDeploymentsSchedulePostRequest {
