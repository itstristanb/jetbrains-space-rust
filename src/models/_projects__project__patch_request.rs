...
pub struct ProjectsProjectPatchRequest {
    #[serde(rename = "key", skip_serializing_if = "Option::is_none")]
    pub key: Option<Box<crate::models::ProjectKey>>,
...
impl ProjectsProjectPatchRequest {
    pub fn new() -> ProjectsProjectPatchRequest {
        ProjectsProjectPatchRequest {
            key: None,
            name: None,
            description: None,
            private: None,
