...
pub struct ProjectsProjectAutomationDeploymentsFinishPostRequest {
...
impl ProjectsProjectAutomationDeploymentsFinishPostRequest {
    pub fn new(target_identifier: crate::models::TargetIdentifier) -> ProjectsProjectAutomationDeploymentsFinishPostRequest {
